...
#
#   Purpose: Demonstarte how to pass wavriables from function to function 
#                   while producing a functional game.
#
#                   Remember, function_name(variable) _means , that we pass in
#                   the variable. return variable_means that we are returning the variable to
#                   back to the calling funtion.
...
def describe_game(name):
    """
        Check if this is a new a game or not.
